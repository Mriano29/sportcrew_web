    ...
    const handleFollowUser = async (targetUser: User) => {
        ...
        if (targetUser.isFollowed) {
            ...
            if (unfollowError || removeFollowerError) {
                console.error("Error unfollowing:", unfollowError?.message || removeFollowerError?.message);
                return;
            }
            ...
            if (followError || addFollowerError) {
                console.error("Error following:", followError?.message || addFollowerError?.message);
                return;
            }
        ...
        <div className="w-full flex justify-center lg:justify-start">
            <div className="relative w-full max-w-md" ref={containerRef}>
                <div className="flex items-center border-2 rounded-xl p-2">
                    ...
                    />
                    <button onClick={handleSearchClick} className="p-1" disabled={loading}>
                                ...
                                <div key={result.id} className="p-2 cursor-pointer">
                                    <div className="flex items-center gap-2 p-2">
                                        ...
                                        <div className="ml-auto">
                                            <button
                                                className={`rounded-md px-2 py-1 text-sm ${result.isFollowed
